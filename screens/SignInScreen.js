    ...
    render() {
        return (
            <View style={styles.screen}>
                ...
                <Text style={{ fontFamily: 'Poppins-Medium', fontSize: 30, marginVertical: 20, color: "#323232" }}>Login</Text>

                <View style={{ marginBottom: 10 }}>
                    <Text style={{ color: "#A6A6A6", fontSize: 14, fontFamily: "Poppins-Regular" }}>Email</Text>
                ...
                <View style={{ marginBottom: 20 }}>
                    <Text style={{ color: "#A6A6A6", fontSize: 14, fontFamily: "Poppins-Regular" }}>Password</Text>
                    <View>
                        <TextInput style={styles.input}
                ...
                <View style={{ justifyContent: 'center', alignItems: 'center' }}>
                    ...
                    <View style={{ flexDirection: 'row', }}>
                        <Text style={{ color: "#A6A6A6", marginRight: 10, fontSize: 14, fontFamily: "Poppins-Regular" }}>Don't have an account ?
                        </Text>
                        <TouchableOpacity style={styles.btnWhite}
                            onPress={() => { this.props.navigation.navigate('signup_screen') }}>
                            <Text style={{ fontSize: 14, fontFamily: "Poppins-Regular" }}>Sign Up</Text>
                        </TouchableOpacity>
                    </View>
                </View>
