        ...
        return (
            <View style={styles.screen}>
                ...
                <View style={{ paddingBottom: 10, }}>
                    <View style={{ flexDirection: 'row', marginVertical: 20, marginHorizontal: 15, flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start' }}>
                        <Text style={{ fontSize: 30, color: "#323232", fontFamily: 'Poppins-Medium', }}>Featured</Text>
                    </View>
